...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Spawn Robot into Gazebo with Nav2')
    ...
    if args.turtlebot_type is not None:
        if args.robot_name == "leader":
            sdf_file_path = os.path.join(
                get_package_share_directory('final_project'), 'models',
                'waffle_leader', 'model.sdf')
        elif args.robot_name == "follower":
            sdf_file_path = os.path.join(
            ...
            # if args.aruco_id == 0:
            #     sdf_file_path = os.path.join(
            #         get_package_share_directory('tb3_gazebo'), 'models',
            #         'turtlebot3_waffle', 'model_robot2_aruco0.sdf')
            # elif args.aruco_id == 1:
            #     sdf_file_path = os.path.join(
            #         get_package_share_directory('tb3_gazebo'), 'models',
            #         f'turtlebot3_waffle', 'model_robot2_aruco1.sdf')
            # elif args.aruco_id == 2:
            #     sdf_file_path = os.path.join(
            #         get_package_share_directory('tb3_gazebo'), 'models',
            #         f'turtlebot3_waffle', 'model_robot2_aruco2.sdf')
            # elif args.aruco_id == 3:
            #     sdf_file_path = os.path.join(
            #         get_package_share_directory('tb3_gazebo'), 'models',
            #         f'turtlebot3_waffle', 'model_robot2_aruco3.sdf')
            # else:
            #     sdf_file_path = os.path.join(
            #         get_package_share_directory('tb3_gazebo'), 'models',
            #         f'turtlebot3_waffle', 'model_robot2_aruco0.sdf')
    else:
