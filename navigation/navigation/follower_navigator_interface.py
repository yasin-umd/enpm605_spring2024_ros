...
class FollowerNavigatorInterface(Node):
    def __init__(self):
        super().__init__(node_name="follower_navigator")
        ...
        self.nav_through_poses_client = ActionClient(
            self, NavigateThroughPoses, "/follower/navigate_through_poses"
        )
        self.nav_to_pose_client = ActionClient(
            self, NavigateToPose, "/follower/navigate_to_pose"
        )
        self.follow_waypoints_client = ActionClient(
            self, FollowWaypoints, "/follower/follow_waypoints"
        )
