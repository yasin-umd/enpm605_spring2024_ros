        ...
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(final_project_launch_dir, "slam_launch.py")
                ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(final_project_launch_dir, "localization_launch.py")
                ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(final_project_launch_dir, "navigation_launch.py")
                ),
                launch_arguments={
                    "namespace": namespace,
                    "use_sim_time": use_sim_time,
