...
def generate_launch_description():
    ...
    rviz_config_file = os.path.join(bringup_dir, "config", "robots.rviz")
    ...
    declare_world_cmd = DeclareLaunchArgument(
        "world",
        default_value=os.path.join(bringup_dir, "world", "final.world"),
    ...
    declare_robot2_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(bringup_dir, "params", "follower_params.yaml"),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config",
        default_value=os.path.join(bringup_dir, "config", "nav2_namespaced_view.rviz"),
